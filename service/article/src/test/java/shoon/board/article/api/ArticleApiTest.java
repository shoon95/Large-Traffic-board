package shoon.board.article.api;
...
public class ArticleApiTest {
    ...
    @Test
    void readTest() {
        ArticleResponse response = read(146451709491736576L);
        System.out.println("response = " + response);
    }
    ...
    @Test
    void updateTest() {
        update(146456794528145408L);
        ArticleResponse response = read(146456794528145408L);
        System.out.println("response = " + response);
    }
    ...
    void update(Long articleId) {
         restClient.put()
                .uri("/v1/articles/{articleId}", articleId)
                .body(new ArticleUpdateRequest("hi 3", "my content 33"))
                .retrieve()
                .toBodilessEntity();
    }
    ...
    void deleteTest() {
        restClient.delete()
                .uri("/v1/articles/{articleId}", 146456794528145408L)
                .retrieve()
                .toBodilessEntity();
    }
